...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /*title.scanner를 이용해서 값 입력 해보기. */

            /* index 1. scanner 클래스 사용할준비 */
        Scanner sc = new Scanner(System.in);

        //출력 맨뒤에 들어가는 in의 의미는 개행(줄바꿈의, enter 키) 의미이다.
        System.out.println("안녕");
        System.out.print("나는");
        System.out.println("김관훈입니다.");
        ...
        char ch = sc.nextLine().charAt(1); //컴퓨터 숫자는 대부분 0부터 시작한다. 바로옆에 숫자는 0부터해서 순서로 글자열에 맞게 출력이됨 ex)hi = i가 출력됨
