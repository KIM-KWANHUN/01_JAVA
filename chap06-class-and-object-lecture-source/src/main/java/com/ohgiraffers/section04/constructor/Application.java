...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   우리가 지금까지 작성하지 않고도 사용할 수 있게 되었다. */
        ...
        UserDTO user = new UserDTO(); //오른쪽 new 옆에있는 UserDTO 는 생성자라고 불리운 메소드 이다.
        System.out.println("user 의 초기값 : " + user.toString());

        /* comment.
        *   주의점 : 기본 생성자로 인스턴스를 생성하게 되면 jvm 이 제공하는 기본값들로
        *   값이 초기화가 된다. ex) name = null
        ...
        *   따라서 이 점을 주의해야 한다. */
        ...
        UserDTO user2 = new UserDTO("user01","pass01","김관훈");
        System.out.println("user2의 초기값 : " + user2.toString()); //매개변수가 있는 생성자

        UserDTO user3 = new UserDTO("user03","pass03","김관훈", LocalDateTime.now());
