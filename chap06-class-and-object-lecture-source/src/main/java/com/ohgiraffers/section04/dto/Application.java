...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *         만약 호출시 인자가 많아지는 경우 어떤 값이 어떤 필드를 의미하는 지 헷갈린다. */

        UserDTO user1 = new UserDTO("user01","pass01","김관훈", LocalDateTime.now()); //기본 생성자 호출 null 등 기본값으로 일단 채워짐
        System.out.println("user01 정보 : " + user1.toString());

        /* index 2. 기본생성자와 설정자를 이용한 초기화 */
        /* comment.
        *   장점 : 필드를 초기화 하는 값들이 어떤 필드를 지칭하는지 명확하게 알 수 있다.
        *   단점 : 하나의 인스턴스 생성할 때, 한 번의 호출로 끝나지 않는다. */
