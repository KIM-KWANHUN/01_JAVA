...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* comment.
        *   static
        *   정정 메모리 영역에 프로그램이 start 될 때 할당하는 키워드이다.
        ...
        *  */
        ...
        System.out.println("nonStatic 필드 값 : " + sf1.getNonStaticCount());
        System.out.println("Static 필드 값 : " + sf1.getStaticCount());

        /* index 2. 두 필드의 값을 1씩 증가하는 메소드 호출 */
        ...
        System.out.println("nonStatic 필드 값 : " + sf2.getNonStaticCount());
        System.out.println("Static 필드 값 : " + sf2.getStaticCount());

        /* comment.
        *   인스턴스 변수의 경우에는 sft1 과 sft2 두 개의 인스턴스가
        *   서로 값을 공유하지 못 한다.
        *   따라서 new 키워드를 만나는 순간 0 이라는 기본값으로 초기화 된다.
