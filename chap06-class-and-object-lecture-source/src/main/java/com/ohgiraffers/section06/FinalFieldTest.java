...
//    private final int nonStaticNum;
    ...
    private final int NON_STATIC_NUM = 1;// 변수선언과 동시에 초기화

    /* index 2-2. 해결방안 2. 생성자를 통해 초기화를 한다. */
    private final String NON_STATIC_NAME;

    public FinalFieldTest(String nonStaticName) {
        this.NON_STATIC_NAME = nonStaticName; //생성자 만들기
    }

    /* index 2. static 필드에 final 키워드 사용 */
//    private static final int STATIC_NUM; // 0이라는 기본값이기 때문에 오류 발생
    private static final double PI = 3.14; // 선언과 동시에 초기화
    /* comment.
