...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        *   == 연산으로 비교 시 서로 동일한 주소를 비교하여 true 를 반환한다. */
        ...
        System.out.println("str3 == str4 : " + (str3 == str4)); // new 라는 키워드를 만나면 항상 새로운 공간을 만들어준다. 그래서 둘은 false 이다.

        /* comment.
        *   문자열의 가장 큰 특징은 불변이다.
        *   기존에 문자열에 + 연산을 수행하는 경우 문자열을 수정하는 것이 아닌,
        *   새로운 문자열을 할당하게 된다.
        *   즉 새로운 공간을 만들어서 javamysql 이라는 새로운 공간이 생성되기 때문에 false 가 나온다. */
        str1 += "mysql";
        System.out.println("str1 == str2 : " + (str1 == str2));
        ...
        *   위해서는 == 연산 대신, equals() 메소드를 사용해야 한다. */
        // equals()는 단순히 값만을 비교하는 메소드 이다. 그래서 true 가 나온다.
