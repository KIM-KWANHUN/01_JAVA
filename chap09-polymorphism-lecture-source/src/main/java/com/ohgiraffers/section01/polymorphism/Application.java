...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   그렇기 때문에 하나의 타입으로 여러 타입의 인스턴스를 처리할 있고
...
//            개구리 f1 = new 동물()
        ...
        *   런타임 시 실제 객체가진 오버라이딩 된 메소드로 바인딩이 바뀌어
        *   동작 하는 것을 의미한다. */
        ...
        *   고유의 기능은 작동 시킬 수 없다. */
        ...
        // 주의 사항 : 타입 형변환을 잘못하게 되면 컴파일 시에는 문제가 없지만, 런타임시 ClassCast 오류 발생
        //((너구리)a1).깨물기();

        /* index 4. instanceof 연산자로 확인 */
        System.out.println("==================instanceof=================");
        System.out.println("a1이 개구리 타입인 지 확인 : " + (a1 instanceof 개구리)); // true
        System.out.println("a1이 너구리 타입인 지 확인 : " + (a1 instanceof 너구리)); // false
        System.out.println("a1이 동물 타입인 지 확인 : " + (a1 instanceof 동물)); // true
        System.out.println("a1이 Object 타입인 지 확인 : " + (a1 instanceof Object)); // ture
        ...
        *   down : 하위 타입으로 형변환 ex) 동물 -> 개구리 */
        ...
        동물 a3 = (동물)new 개구리(); // up-casting 자동 형변환
        너구리 a4 = (너구리)new 동물(); // down-casting 강제 형변환
