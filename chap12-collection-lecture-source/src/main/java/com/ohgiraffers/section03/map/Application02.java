...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        *   즉 key 도 문자열 value 도 문자열 이여야 한다!!!! 대부분 설정관련 파일만 읽음 <- 중요!! */
        ...
        System.out.println("prop = " + prop); // 순서 x Map 의 형태랑 똑같으나 key 와 value 모두 String 타입으로 넣어야 된다.

        // 예외 처리 -> 파일의 입력과 출력에 대한 것은 예외처리를 강제화
        try {
