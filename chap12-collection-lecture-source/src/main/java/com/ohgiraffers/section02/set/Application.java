...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   해시 알고리즘을 사용해서 검색 속도가 빠르다는 장점을 가지고 있다. */
        ...
        // 1. 저장 순서 유지 안 함.
        System.out.println("hset = " + hset); // 출력할시에 저장한 순서를 기억하지 않고 무작위로 출력된다.
        ...
        System.out.println("mysql 포함 되어 있는 지 확인 : " + hset.contains("mysql"));
        ...
        *   저장 된 객체를 하나씩 꺼낼 방법이 없다. */
        ...
        /* index 2. iterator() 반복자를 통한 목록화 연습처리 */
