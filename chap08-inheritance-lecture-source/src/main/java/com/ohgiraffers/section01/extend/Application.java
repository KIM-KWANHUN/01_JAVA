...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   메소드를 재정의하게 된다면 재정의한 메소드가 우선동작을한다. */
        ...
        /* comment.
        *   상속은 물려 받는 것 뿐만 아니라 확장도 할 수 있다. */
        fireCar.sprayWater();
        // 부모인 카의 클래스에는 car.sprayWater 를 사용할 수 없다.

        /* comment.
        *   상속이라는 기능을 사용하게 되면 얻는 장점
        ...
        *   상속이라는 기능을 사용하게 되면 얻는 단점
        *   1. 부모클래스의 기능을 추가/변경 할 시 자식클래스가 정상적으로 동작하는 지 예측이 어렵다.
        *      상속 구조가 복잡해 질 수록 그 영향에 대한 예측이 힘들어지며
        *      이러한 복잡한 구조는 오히려 유지보수성을 악화 시킨다.
