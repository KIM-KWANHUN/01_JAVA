...
public class Product {
    ...
    public Product(String code, String brand, String name, int price, LocalDateTime manufacturingDate) { // 모든필드를 초기화 하는 생성자
        /* comment.
        *   Product 클래스는 아무런 클래스도 상속받고 있지 않지만,
        *   super() 가 호출이 되고 있다.
        *   => 모든 클래스는 우리가 명시적으로 작성하고 있지는 않지만
