...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* title. 배열에 대해 이해하고 배열의 사용 목적을 이애할 수 있다. */
        
        /* comment.
        *   배열이란?
        *   동일한 자료형의 묶음(연속된 메모리 공간에 값을 저장하고 사용하기 위한 용도)
        *   배열은 heap 영역에  new 연산자를 이용해 할당을 가지게 된다.
        *   new : 할당 연산자 */ //간단히말하면 변수는 한개만 넣을수 잇지만 여러개로 입력 할 수 있다.

        /* comment.
        *   배열의 사용 이유
        *   만약 배열을 사용하지 않게 된다면, 필요한 값을 일일히
        *   변수에 담아주어야 한다. 변수는 값 1개만을 저장할수 있기 때문에
