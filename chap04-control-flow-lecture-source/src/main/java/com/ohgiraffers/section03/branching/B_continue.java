...
public class B_continue {
    ...
    public void testContinueStatement(){
        ...
        /* comment.
        *   continue 문도 break와 마찬가지로 반복문 내에서 사용한다.
        ...
        *   사용이 된다. */
        ...
        /* index. 1부터 100사이의 3의 배수이면서 4의 배수인 값 */
        for(int i =1 ; i < 101; i ++){
    ...
    public void testContinueStatement2(){
        ...
        /* index. 2~9단의 구구단을 출력 할 것이다.
        *   단, 수 5인 경우는 출력하지 않을 것 이다. */
        for(int dan = 2; dan < 10; dan++){ //반복문 사용

            for(int su = 1; su < 10; su++){ //반복문 사용

                if(su == 5){ //그러나 5는 출력하지않는다.
                    continue;
                }
